...
const { verifyState } = require('./utils')
const { badgeRunner } = require('./badgeRunner')

const { DEFAULT_CONFIG_NAME, DEFAULT_STATE } = require('./constants/defaults')
...
function loadConfig(
  cliOpts,
  moduleLoaderFunction = loadModule,
  badgeRunnerFunc = badgeRunner,
  verifyFunc = verifyState,
) {
